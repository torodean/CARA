...
def test_format_entry_all_fields():
    ...
    entry = GitLogEntry("abc1234", "Alice", "2024,08,12,Monday,August", "2024-08-12", "Initial commit")
...
def test_group_by_time_unit(unit, key_format):
    ...
    """
    entry1 = GitLogEntry("abc1234", "Alice", "2024,08,12,Monday,August", "2024-08-12", "Commit one")
    entry2 = GitLogEntry("def5678", "Bob", "2024,08,13,Tuesday,August", "2024-08-13", "Commit two")
...
def test_generate_day_grouping():
    ...
    """
    entry = GitLogEntry("abc1234", "Alice", "2024,08,12,Monday,August", "2024-08-12", "Commit message")
